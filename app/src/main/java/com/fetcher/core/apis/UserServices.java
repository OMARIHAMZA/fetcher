...
public interface UserServices {
    ...
    Call<MessagesResponse> registerUser(@Part("name") String name,
    ...
    @POST("api/auth/register")
    Call<MessagesResponse> registerUser(@Body RequestBody body);
    ...
    @GET("api/jobOpportunities/search/{query}")
    Call<OffersResponse> searchJobs(@Header("Authorization") String token, @Path("query") String query);

    @GET("api/trainingOpportunities/search/{query}")
    Call<OffersResponse> searchTrainings(@Header("Authorization") String token, @Path("query") String query);
}
