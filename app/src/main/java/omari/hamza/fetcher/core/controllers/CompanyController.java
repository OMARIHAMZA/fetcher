...
import omari.hamza.fetcher.core.apis.CompanyServices;
...
import omari.hamza.fetcher.views.activities.companies.CompanyProfileActivity;
...
public class CompanyController {
    ...
    public static void acceptJobApplication(@NonNull Context context, int applicationId, Callback<MessageResponse> callback) {
        CompanyServices companyServices = RetrofitClientInstance.getRetrofitInstance().create(CompanyServices.class);
        Call<MessageResponse> call = companyServices.acceptJobApplication(UserUtils.getUserToken(context), applicationId,
                "Congratulation, you have been selected to make an interview with us!\nContact us ASAP!");
        call.enqueue(callback);
    }
    ...
    public static void acceptTrainingApplication(@NonNull Context context, int trainingId, Callback<MessageResponse> callback) {
        CompanyServices companyServices = RetrofitClientInstance.getRetrofitInstance().create(CompanyServices.class);
