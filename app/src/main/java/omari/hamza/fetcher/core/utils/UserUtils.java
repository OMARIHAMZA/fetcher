...
public class UserUtils {
    ...
    public static final String COMPANY_WEBSITE_TAG = "WEBSITE";
    public static final String COMPANY_EMAIL_TAG = "COMPANY_EMAIL";
    public static final String COMPANY_ADDRESS_TAG = "COMPANY_ADDRESS";
